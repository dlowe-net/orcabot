...
(frag -> (or
          ...
          ("Yes baby, I'm " number " feet tall and have " number " rows o' " body-part-plural "; I was suckled by a " pet ", I gave " she-being " a high-protein tonsil wash!")
          ...
          ("I " act "!")
          (being "'s hands are my *ideal* playground!")
          ("I hold the " number "-Bladed Windbreaker; the wheels that turn are behind me; I think *backwards*!")
          ("I do it for *fun*!")
          ...
          ("I am a Thuggee, I am feared in the Tongs, I have the Evil " body-part ", I carry the Mojo Bag; I swam *" place "* and didn't get wet!")
          ...
          ("I've packed the brownies of the " entities ", I leak the Plague from my " body-part-plural ", opiates are the *mass* of my religion, *I " act "!*")
          ("Yes, I'm a rip-snorter, I cram coca leaves right into my " body-part-plural "before they're picked off the *tree*!")
          ("*" entities "* cringe at my tread!")
          ("I " act ".")
...
(emphatic -> (or "frakking" "damned" "DAMN" "fscking"))

(attack -> (or "blow me down" "gouge with me" "come and get me"
               "engage me in a battle of wits"
               "tear flesh with me"))

(spoor -> (or "spoor" "seed" "breath" "sweat" "spew"))

(number -> (or "seven" "23" "13" "666" "273" "42"))

(entity -> (or
            "a Crime Fighting Master Criminal"
            ("a "pet)
            "the bigfooted devil of Level 14"
            "the last remaining Homo Correctus"
            ("the " emphatic " Man of the Future" )
            ("a human being of the *first* " emphatic " water")
            ("the javalina humping junkie that jumped the " entities)))

(pet -> (or "pterodactyl" "python" "triceratops" "giant lizard"))

(being -> (or she-being he-being))

(she-being -> (or "Mother Nature" "God" "the Anti-Virgin"))

(he-being -> (or "the Devil" "Father Time" "Jesus" "the Wolf Man"))

(entities -> (or "bodiless fiends" "Men from Mars"
...
(body-part -> (or "nose" "gut" "arm-vein" "nether part"
                  "backbone" "brow" "teat"))

(body-part-plural -> (or "noses" "guts" "arm-veins" "nether parts"
                  "backbones" "brows" "teats"))

(yell -> (or "YEEE HAW!" "YEE! YEEE!" "*Yip, yip, YEEEEEEE!*"
             "YEEEEEHAW!" "YAH-HOOOO!"))

(slogan -> (or "Fuck 'em if they can't take a joke!" "Anything for a laugh!"
...
(adjective -> (or "*fuel-injected*" "*immune*" "*radioactive*"
                  "*supernatural*" "*intense*"))

(place -> (or "China" "Hong Kong" "Asia" "the Atlantis Zoo" "the Cosmos"
